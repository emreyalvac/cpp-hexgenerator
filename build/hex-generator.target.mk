...
TOOLSET := target
TARGET := hex-generator
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=hex-generator' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
$(builddir)/hex-generator.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/hex-generator.node: LIBS := $(LIBS)
$(builddir)/hex-generator.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/hex-generator.node: TOOLSET := $(TOOLSET)
$(builddir)/hex-generator.node: $(OBJS) $(builddir)/nothing.a FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/hex-generator.node
# Add target alias
.PHONY: hex-generator
hex-generator: $(builddir)/hex-generator.node

# Short alias for building this executable.
.PHONY: hex-generator.node
hex-generator.node: $(builddir)/hex-generator.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/hex-generator.node
